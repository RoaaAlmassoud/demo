...
export default class Particles {
    ...
    initPoints(discard) {
        ...
        const material = new THREE.RawShaderMaterial({
            ...
            fragmentShader: currSample === 0 ? glslify(require('../../../shaders/particle1.frag'))
                : currSample === 1 ? glslify(require('../../../shaders/particle2.frag')) : glslify(require('../../../shaders/particle3.frag')),
            depthTest: false,
            transparent: true,
